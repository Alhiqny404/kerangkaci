...
<head>
  ...
  if ($this->uri->segment(2) == "" || $this->uri->segment(2) == "index") {
    ?>
    <link rel="stylesheet" href="<?= base_url('stisla/'); ?>assets/modules/jqvmap/dist/jqvmap.min.css">
    <link rel="stylesheet" href="<?= base_url('stisla/'); ?>assets/modules/summernote/summernote-bs4.css">
    <link rel="stylesheet" href="<?= base_url('stisla/'); ?>assets/modules/owlcarousel2/dist/assets/owl.carousel.min.css">
    <link rel="stylesheet" href="<?= base_url('stisla/'); ?>assets/modules/owlcarousel2/dist/assets/owl.theme.default.min.css">
    <?php
  } elseif ($this->uri->segment(2) == "index_0") {
    ?>
    <link rel="stylesheet" href="<?= base_url('stisla/'); ?>assets/modules/jqvmap/dist/jqvmap.min.css">
    <link rel="stylesheet" href="<?= base_url('stisla/'); ?>assets/modules/weather-icon/css/weather-icons.min.css">
    <link rel="stylesheet" href="<?= base_url('stisla/'); ?>assets/modules/weather-icon/css/weather-icons-wind.min.css">
    <link rel="stylesheet" href="<?= base_url('stisla/'); ?>assets/modules/summernote/summernote-bs4.css">
    <?php
  } elseif ($this->uri->segment(2) == "bootstrap_card") {
    ?>
    <link rel="stylesheet" href="<?= base_url('stisla/'); ?>assets/modules/chocolat/dist/css/chocolat.css">
    <?php
  } elseif ($this->uri->segment(2) == "bootstrap_modal") {
    ?>
    <link rel="stylesheet" href="<?= base_url('stisla/'); ?>assets/modules/prism/prism.css">
    <?php
    ...
    ?>
    <link rel="stylesheet" href="<?= base_url('stisla/'); ?>assets/modules/dropzonejs/dropzone.css">
    <?php
  } elseif ($this->uri->segment(2) == "components_statistic") {
    ?>
    <link rel="stylesheet" href="<?= base_url('stisla/'); ?>assets/modules/jqvmap/dist/jqvmap.min.css">
    <link rel="stylesheet" href="<?= base_url('stisla/'); ?>assets/modules/flag-icon-css/css/flag-icon.min.css">
    <?php
    ...
    ?>
    <link rel="stylesheet" href="<?= base_url('stisla/'); ?>assets/modules/bootstrap-daterangepicker/daterangepicker.css">
    <link rel="stylesheet" href="<?= base_url('stisla/'); ?>assets/modules/bootstrap-colorpicker/dist/css/bootstrap-colorpicker.min.css">
    <link rel="stylesheet" href="<?= base_url('stisla/'); ?>assets/modules/select2/dist/css/select2.min.css">
    <link rel="stylesheet" href="<?= base_url('stisla/'); ?>assets/modules/jquery-selectric/selectric.css">
    <link rel="stylesheet" href="<?= base_url('stisla/'); ?>assets/modules/bootstrap-timepicker/css/bootstrap-timepicker.min.css">
    <link rel="stylesheet" href="<?= base_url('stisla/'); ?>assets/modules/bootstrap-tagsinput/dist/bootstrap-tagsinput.css">
    <?php
  } elseif ($this->uri->segment(2) == "forms_editor") {
    ?>
    <link rel="stylesheet" href="<?= base_url('stisla/'); ?>assets/modules/summernote/summernote-bs4.css">
    <link rel="stylesheet" href="<?= base_url('stisla/'); ?>assets/modules/codemirror/lib/codemirror.css">
    <link rel="stylesheet" href="<?= base_url('stisla/'); ?>assets/modules/codemirror/theme/duotone-dark.css">
    <link rel="stylesheet" href="<?= base_url('stisla/'); ?>assets/modules/jquery-selectric/selectric.css">
    <?php
  } elseif ($this->uri->segment(2) == "modules_calendar") {
    ?>
    <link rel="stylesheet" href="<?= base_url('stisla/'); ?>assets/modules/fullcalendar/fullcalendar.min.css">
    <?php
    ...
    ?>
    <link rel="stylesheet" href="<?= base_url('stisla/'); ?>assets/modules/ionicons/css/ionicons.min.css">
    <?php
