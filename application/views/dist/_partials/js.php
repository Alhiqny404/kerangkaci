...
if ($this->uri->segment(2) == "" || $this->uri->segment(2) == "index") {
  ...
  ?>
  <script src="<?= base_url('stisla/'); ?>assets/modules/simple-weather/jquery.simpleWeather.min.js"></script>
  <script src="<?= base_url('stisla/'); ?>assets/modules/chart.min.js"></script>
  <script src="<?= base_url('stisla/'); ?>assets/modules/jqvmap/dist/jquery.vmap.min.js"></script>
  <script src="<?= base_url('stisla/'); ?>assets/modules/jqvmap/dist/maps/jquery.vmap.world.js"></script>
  <script src="<?= base_url('stisla/'); ?>assets/modules/summernote/summernote-bs4.js"></script>
  <script src="<?= base_url('stisla/'); ?>assets/modules/chocolat/dist/js/jquery.chocolat.min.js"></script>
  <?php
  ...
  ?>
  <script src="<?= base_url('stisla/'); ?>assets/modules/chocolat/dist/js/jquery.chocolat.min.js"></script>
  <script src="<?= base_url('stisla/'); ?>assets/modules/jquery-ui/jquery-ui.min.js"></script>
  <?php
} elseif ($this->uri->segment(2) == "bootstrap_modal") {
  ?>
  <script src="<?= base_url('stisla/'); ?>assets/modules/prism/prism.js"></script>
  <?php
} elseif ($this->uri->segment(2) == "layout_transparent") {
  ?>
  <script src="<?= base_url('stisla/'); ?>assets/modules/sticky-kit.js"></script>
  <?php
  ...
  ?>
  <script src="<?= base_url('stisla/'); ?>assets/modules/dropzonejs/min/dropzone.min.js"></script>
  <?php
  ...
  <script src="<?= base_url('stisla/'); ?>assets/modules/jqvmap/dist/jquery.vmap.min.js"></script>
  <script src="<?= base_url('stisla/'); ?>assets/modules/jqvmap/dist/maps/jquery.vmap.world.js"></script>
  <script src="<?= base_url('stisla/'); ?>assets/modules/jqvmap/dist/maps/jquery.vmap.indonesia.js"></script>
  <?php
  ...
  ?>
  <script src="<?= base_url('stisla/'); ?>assets/modules/cleave-js/dist/cleave.min.js"></script>
  <script src="<?= base_url('stisla/'); ?>assets/modules/cleave-js/dist/addons/cleave-phone.us.js"></script>
  <script src="<?= base_url('stisla/'); ?>assets/modules/jquery-pwstrength/jquery.pwstrength.min.js"></script>
  <script src="<?= base_url('stisla/'); ?>assets/modules/bootstrap-daterangepicker/daterangepicker.js"></script>
  <script src="<?= base_url('stisla/'); ?>assets/modules/bootstrap-colorpicker/dist/js/bootstrap-colorpicker.min.js"></script>
  <script src="<?= base_url('stisla/'); ?>assets/modules/bootstrap-timepicker/js/bootstrap-timepicker.min.js"></script>
  <script src="<?= base_url('stisla/'); ?>assets/modules/bootstrap-tagsinput/dist/bootstrap-tagsinput.min.js"></script>
  <script src="<?= base_url('stisla/'); ?>assets/modules/select2/dist/js/select2.full.min.js"></script>
  <script src="<?= base_url('stisla/'); ?>assets/modules/jquery-selectric/jquery.selectric.min.js"></script>
  <?php
} elseif ($this->uri->segment(2) == "forms_editor") {
  ?>
  <script src="<?= base_url('stisla/'); ?>assets/modules/summernote/summernote-bs4.js"></script>
  <script src="<?= base_url('stisla/'); ?>assets/modules/codemirror/lib/codemirror.js"></script>
  <script src="<?= base_url('stisla/'); ?>assets/modules/codemirror/mode/javascript/javascript.js"></script>
  <script src="<?= base_url('stisla/'); ?>assets/modules/jquery-selectric/jquery.selectric.min.js"></script>
  <?php
  ...
  <script src="<?= base_url('stisla/'); ?>assets/modules/gmaps.js"></script>
  <?php
} elseif ($this->uri->segment(2) == "modules_calendar") {
  ?>
  <script src="<?= base_url('stisla/'); ?>assets/modules/fullcalendar/fullcalendar.min.js"></script>
  <?php
  ...
  <script src="<?= base_url('stisla/'); ?>assets/modules/summernote/summernote-bs4.js"></script>
  <script src="<?= base_url('stisla/'); ?>assets/modules/jquery-selectric/jquery.selectric.min.js"></script>
  <script src="<?= base_url('stisla/'); ?>assets/modules/upload-preview/assets/js/jquery.uploadPreview.min.js"></script>
  <script src="<?= base_url('stisla/'); ?>assets/modules/bootstrap-tagsinput/dist/bootstrap-tagsinput.min.js"></script>
  <?php
...
if ($this->uri->segment(2) == "" || $this->uri->segment(2) == "index") {
  ...
  ?>
  <script src="<?= base_url('stisla/'); ?>assets/js/page/bootstrap-modal.js"></script>
  <?php
} elseif ($this->uri->segment(2) == "components_chat_box") {
  ?>
  <script src="<?= base_url('stisla/'); ?>assets/js/page/components-chat-box.js"></script>
  <?php
} elseif ($this->uri->segment(2) == "components_multiple_upload") {
  ?>
  <script src="<?= base_url('stisla/'); ?>assets/js/page/components-multiple-upload.js"></script>
  <?php
} elseif ($this->uri->segment(2) == "components_statistic") {
  ?>
  <script src="<?= base_url('stisla/'); ?>assets/js/page/components-statistic.js"></script>
  <?php
} elseif ($this->uri->segment(2) == "components_table") {
  ?>
  <script src="<?= base_url('stisla/'); ?>assets/js/page/components-table.js"></script>
  <?php
} elseif ($this->uri->segment(2) == "components_user") {
  ?>
  <script src="<?= base_url('stisla/'); ?>assets/js/page/components-user.js"></script>
  <?php
} elseif ($this->uri->segment(2) == "forms_advanced_form") {
  ?>
  ...
  ?>
  <script src="<?= base_url('stisla/'); ?>assets/js/page/gmaps-advanced-route.js"></script>
  <?php
} elseif ($this->uri->segment(2) == "gmaps_draggable_marker") {
  ?>
  <script src="<?= base_url('stisla/'); ?>assets/js/page/gmaps-draggable-marker.js"></script>
  <?php
} elseif ($this->uri->segment(2) == "gmaps_geocoding") {
  ?>
  <script src="<?= base_url('stisla/'); ?>assets/js/page/gmaps-geocoding.js"></script>
  <?php
} elseif ($this->uri->segment(2) == "gmaps_geolocation") {
  ?>
  <script src="<?= base_url('stisla/'); ?>assets/js/page/gmaps-geolocation.js"></script>
  <?php
} elseif ($this->uri->segment(2) == "gmaps_marker") {
  ?>
  <script src="<?= base_url('stisla/'); ?>assets/js/page/gmaps-marker.js"></script>
  <?php
} elseif ($this->uri->segment(2) == "gmaps_multiple_marker") {
  ?>
  <script src="<?= base_url('stisla/'); ?>assets/js/page/gmaps-multiple-marker.js"></script>
  <?php
} elseif ($this->uri->segment(2) == "gmaps_route") {
  ?>
  <script src="<?= base_url('stisla/'); ?>assets/js/page/gmaps-route.js"></script>
  <?php
} elseif ($this->uri->segment(2) == "gmaps_simple") {
  ?>
  <script src="<?= base_url('stisla/'); ?>assets/js/page/gmaps-simple.js"></script>
  <?php
} elseif ($this->uri->segment(2) == "modules_calendar") {
  ?>
  <script src="<?= base_url('stisla/'); ?>assets/js/page/modules-calendar.js"></script>
  <?php
} elseif ($this->uri->segment(2) == "modules_chartjs") {
  ?>
  ...
  ?>
  <script src="<?= base_url('stisla/'); ?>assets/js/page/modules-slider.js"></script>
  <?php
} elseif ($this->uri->segment(2) == "modules_sparkline") {
  ?>
  <script src="<?= base_url('stisla/'); ?>assets/js/page/modules-sparkline.js"></script>
  <?php
} elseif ($this->uri->segment(2) == "modules_sweet_alert") {
  ?>
  ...
  ?>
  <script src="<?= base_url('stisla/'); ?>assets/js/page/modules-vector-map.js"></script>
  <?php
} elseif ($this->uri->segment(2) == "auth_register") {
  ?>
  ...
  ?>
  <script src="<?= base_url('stisla/'); ?>assets/js/page/features-post-create.js"></script>
  <?php
} elseif ($this->uri->segment(2) == "features_posts") {
  ?>
  <script src="<?= base_url('stisla/'); ?>assets/js/page/features-posts.js"></script>
  <?php
} elseif ($this->uri->segment(2) == "features_setting_detail") {
  ?>
  <script src="<?= base_url('stisla/'); ?>assets/js/page/features-setting-detail.js"></script>
  <?php
} elseif ($this->uri->segment(2) == "utilities_contact") {
  ?>
  <script src="<?= base_url('stisla/'); ?>assets/js/page/utilities-contact.js"></script>
  <?php
} ?>
