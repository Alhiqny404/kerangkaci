...
<script>
  ...
  $(document).ready(function() {
    ...
    table = $('#table').DataTable({
      ...
      "serverSide": true,
      "ajax": {
        "url": "<?php echo site_url('crud-backend/submenu/ajaxList') ?>",
        "type": "POST"
      },
  ...
  function status(id) {
    $.ajax({
      url: "<?= site_url('crud-backend/submenu/status'); ?>",
      type: "post",
      cache: false,
      data: {
        id: id
  ...
  function edit(id) {
    ...
    $.ajax({
      url: "<?= site_url('crud-backend/submenu/ajax_edit/') ?>" + id,
      type: "POST",
      dataType: "JSON",
      cache: false,
  ...
  function save() {
    var url;
    if (save_method == 'add') {
      url = "<?= site_url('crud-backend/submenu/ajax_add') ?>";
    } else
    {
      url = "<?= site_url('crud-backend/submenu/ajax_update') ?>";
    }
  ...
  function delete_submenu(id) {
    ...
    .then((willDelete) => {
      if (willDelete) {
        ...
        $.ajax({
          url: "<?php echo site_url('crud-backend/submenu/ajax_delete/') ?>"+id,
          type: "POST",
          dataType: "JSON",
          cache: false,
          success: function(data) {
