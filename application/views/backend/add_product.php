              ...
              <form id="form">
                ...
                <div class="form-row">
                  <div class="form-group col-md-7">
                    ...
                    <select class="form-control" name="id_categories">
                      <option value="" class="pilih-kategori">--- PILIH KATEGORI ---</option>
                    </select>
                ...
                <div class="form-group row">
                  ...
                  <div class="col-sm-10">
                    ...
                    <img width="40%" id="blah" class="img-thumbnail" src="<?=base_url('assets/img/avatar.png'); ?>" alt="hero image">
                  </div>
                </div>
...
<script>
  ...
  function save() {
    ...
    $.ajax({
      ...
      url: "<?= site_url('crud-backend/product/save'); ?>",
      type: "post",
      data: dataForm,
      dataType: "json",
      cache: false,
      ...
      success: function(data) {
        ...
        } else
        {
          ...
          CKEDITOR.instances['description_products'].setData('', function() {
            this.updateElement();
          });
          iziToast.success({
            title: 'BERHASIL!',
